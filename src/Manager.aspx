...
<body>
    ...
    <div>
        <div align=" center">
           <h1> <b color ="red">Admin Dashboard</b></h1> 
        </div>
        ...
        <asp:GridView align="center" ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="Username" DataSourceID="SqlDataSourceRegistration" ForeColor="#333333" GridLines="None">
            <AlternatingRowStyle BackColor="White" />
            <Columns>
                <asp:CommandField ShowDeleteButton="True" ShowEditButton="True" ShowSelectButton="True" DeleteText="" />
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString='<%$ ConnectionStrings:RegistrationConnectionString %>' SelectCommand="SELECT * FROM [MsgTable]" DeleteCommand="DELETE FROM [MsgTable] WHERE [Id] = @Id" InsertCommand="INSERT INTO [MsgTable] ([ChatMsg], [MsgSender], [MsgReceiver], [RecevierSeen]) VALUES (@ChatMsg, @MsgSender, @MsgReceiver, @RecevierSeen)" UpdateCommand="UPDATE [MsgTable] SET [ChatMsg] = @ChatMsg, [MsgSender] = @MsgSender, [MsgReceiver] = @MsgReceiver, [RecevierSeen] = @RecevierSeen WHERE [Id] = @Id">
         ...
         <h2 align="center">Chat Database</h2>
        <asp:GridView align="center" ID="GridView2" runat="server" AutoGenerateColumns="False" DataKeyNames="Id" DataSourceID="SqlDataSource1" CellPadding="4" ForeColor="#333333" GridLines="None" AllowPaging="True" AllowSorting="True">
