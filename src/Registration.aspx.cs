...
public partial class Registration : System.Web.UI.Page
{
    ...
    protected void AddUser()
    {
        ...
        //, Profile , @photo
                ...
                SqlCommand sqlcommand = new SqlCommand("Insert into UserDatabase"
                    + "(Username,Email,Password,Country) values(@username, @email, @pass, @country )", sqlConnect);
                ...
                //sqlcommand.Parameters.AddWithValue("@profile", pic);
